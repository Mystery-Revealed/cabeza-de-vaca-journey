...
app.get('/healthz', (_req, res) =>
  res.json({ ok: true, service: 'cabeza-de-vaca-journey', liveSessions: manager.registry.sessions.size }));
...
server.listen(config.port, () => {
  console.log(`[cabeza-de-vaca-journey] listening on :${config.port} — sessions live in memory only`);
});
